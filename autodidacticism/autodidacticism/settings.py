...
SECRET_KEY = '27pa7vz!ieo-&e(9*t50dv%tp88i81mj!o#v4^7ry-jroeih0='
...
INSTALLED_APPS = [
    ...
    # Adding the admin documentation app:
...
# <--------------------Locally Developed Applications-------------------------->
    ...
    'education_resources',
    # Access to Data APIs and associated documentation through 'data_api':
    'data_api'
]
...
# Adding the MEDIA_ROOT for storage of user uploaded static files:
MEDIA_ROOT = os.path.join(BASE_DIR, "media_root_dir")
MEDIA_URL = '/media_root_dir/'
